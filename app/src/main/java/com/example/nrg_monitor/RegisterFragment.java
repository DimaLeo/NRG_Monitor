...
public class RegisterFragment extends Fragment implements View.OnClickListener {
    ...
    private DatabaseRequestHandler databaseHelper;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        databaseHelper = new DatabaseRequestHandler();
        //postRequest = new DBTask(getView().getContext());
        ...
        switch (v.getId()) {
            ...
            case R.id.register_button:
                ...
                if (allValid()) {
                    ...
                    databaseHelper.insertToUsersDb(email.getText().toString(),username.getText().toString(),password.getText().toString());
